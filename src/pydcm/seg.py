...
def write_seg(reference, labelmap, segments, output=None,
              ...
              dimension_organization_uid="", content_date="", content_time=""):
    ...
    return _core.write_seg(_refs(reference), lm, list(segments),
                           ...
                           sop_instance_uid or "", series_instance_uid or "",
                           dimension_organization_uid or "", content_date or "",
                           content_time or "")
...
def write_seg_overlapping(reference, masks, segments, output=None,
                         sop_instance_uid="", series_instance_uid="",
                         dimension_organization_uid="", content_date="", content_time=""):
    ...
    """
    arr = np.ascontiguousarray(np.asarray(masks) != 0, dtype=np.uint8)
    return _core.write_seg_overlapping(_refs(reference), arr, list(segments),
                                       str(output) if output else "",
                                       sop_instance_uid or "", series_instance_uid or "",
                                       dimension_organization_uid or "", content_date or "",
                                       content_time or "")
...
__all__ = ["write_seg", "write_seg_fractional", "write_seg_overlapping", "read_seg",
