...
def write_ko(references, *, patient_name="", patient_id="", study_uid="", study_date="",
             ...
             retrieve_ae_title="", retrieve_location_uid=""):
    ...
    # Retrieve hints stamped on every series item of the evidence sequence.
    # retrieve_location_uid is the XDS-I repositoryUniqueId a consumer echoes
    # into RAD-69; without it a published manifest is not retrievable except by
    # out-of-band configuration.
    if retrieve_ae_title or retrieve_location_uid:
        doc["retrieve"] = {"ae_title": str(retrieve_ae_title or ""),
                           "location_uid": str(retrieve_location_uid or "")}
