...
from . import (uid, valuerep, config, errors, dataset, dataelem, tag, sequence,
               ...
               legacy_converted, ann, opv, dce, tract)
...
from .rt import (read_rtdose, DoseGrid,                         # RT line (native engine): dose grid,
                 write_rtdose, write_rtstruct, dvhcalc, ComputedDVH)  # dose+structure authoring + DVH
...
__all__ = ["decode", "dcmread", "dcmwrite", "Dataset", "DataElement", "Tag",
           ...
           "write_rtstruct", "dvhcalc", "ComputedDVH", "transforms",
           ...
           "render_overlay",
           "write_legacy_converted", "read_ann", "read_surface",
