...
@tool("validate_iod",
      "Validate a DICOM file against its SOP-Class IOD (mandatory modules, Type-1/2 presence, VM, "
      "enumerated values, nested sequences); returns the findings list ([] = conformant).", _PATH)
def _validate(a):
