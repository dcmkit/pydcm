...
# pydcm's registered arc — what generate_uid() mints under by default, so the
# UIDs pydcm creates carry pydcm's own identity.
PYDCM_ROOT_UID = "1.2.826.0.1.3680043.9.7155."
PYDCM_IMPLEMENTATION_UID = "1.2.826.0.1.3680043.9.7155.1"
...
def generate_uid(prefix: str | None = PYDCM_ROOT_UID, entropy_srcs=None) -> UID:
...
# pydcm extra: JPEG XL — natively decoded via libjxl.
